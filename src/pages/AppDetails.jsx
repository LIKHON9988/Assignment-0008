...
export default function AppDetails(){
  ...
  const chartData = app.ratings.map((r) => ({
    name: r.name,
    count: r.count,
    fill: r.name === "5 star" ? "#8884d8" : 
          r.name === "4 star" ? "#9c88e3" : 
          r.name === "3 star" ? "#b08dee" : 
          r.name === "2 star" ? "#c493f9" : "#d89af5"
  }))
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-72">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-sm text-purple-600 mb-4">Developed by {app.companyName || 'productive.io'}</p>
              
              <div className="flex items-center justify-between mb-6 border-b border-gray-100 pb-4">
                <div className="flex flex-col items-center">
                  <span className="text-green-600 font-bold text-lg">
                    {app.downloads >= 1000000 ? `${(app.downloads/1000000).toFixed(1)}M` : `${(app.downloads/1000).toFixed(0)}K`}
                  </span>
                ...
                <div className="flex flex-col items-center">
                  <span className="text-purple-600 font-bold text-lg">
                    {app.reviews >= 1000 ? `${(app.reviews/1000).toFixed(1)}K` : app.reviews}
                  </span>
              ...
              <div className="mb-4">
                <div className="flex items-center mb-2">
                  ...
                  <span className="ml-2 text-xs text-gray-500">{app.size} MB</span>
                </div>
              </div>
          ...
          <div className="flex-1">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="md:w-1/3 flex flex-col items-center justify-center">
                  ...
                  <div className="flex items-center text-amber-400 my-2">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill={i < Math.round(app.ratingAvg) ? "currentColor" : "none"}>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="text-gray-700 space-y-4">
                <p>{app.description}</p>
                <p>
                  This app takes the proven techniques and makes it even more practical for modern lifestyles. 
                  Instead of just setting a timer, it builds a complete environment for deep work, 
                  minimizing distractions and maximizing concentration.
                </p>
                <p>
                  Users can create custom work and break intervals, track how many sessions they complete each day, 
                  and review detailed statistics about their habits over time. The design is minimal and calming, 
                  reducing cognitive load so you can focus entirely on the task at hand.
                </p>
              </div>
            </div>
          </div>
